...
export default function UploadFilesPage() {
  ...
  const { uploadedFiles, handleFileUpload, clearFile, isContinueEnabled } = useMigration();
    ...
    <div className="flex-1 overflow-y-auto bg-slate-50/80">
      <div className="mx-auto flex w-full max-w-[1440px] flex-col gap-6 px-5 py-7 sm:px-7 lg:px-9 lg:py-8">
        ...
        <header className="flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
          <div className="max-w-2xl">
            ...
            <p className="mt-2 text-sm leading-6 text-slate-500">
              Upload the three required workbooks. Once all files are ready, proceed to the Transformation Workspace to validate, clean, and transform your data.
            </p>
          </div>
        ...
        <div className="flex items-center justify-between rounded-xl border border-slate-200 bg-white px-5 py-4 shadow-sm">
          <div className="flex items-center gap-2 text-xs text-slate-500">
            {isContinueEnabled ? (
              <>
                ...
                <span>All files uploaded. Ready to proceed.</span>
              </>
            ) : (
              <>
                <CloudUpload size={15} className="text-slate-400" />
                <span>Upload all three files to continue to the Transformation Workspace.</span>
              </>
            )}
          </div>
          <Button
          ...
          >
            Proceed to Transformation Workspace
            <ArrowRight size={15} />
          </Button>
        </div>
      </div>
