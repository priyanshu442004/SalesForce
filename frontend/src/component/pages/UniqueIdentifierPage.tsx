              ...
              {filteredResults?.map((col) => {
                ...
                return (
                  <div
                    key={col.field}
                    className={cx(
                      "overflow-hidden rounded-xl border bg-white dark:bg-slate-800 transition-all duration-200",
                      isOpen
                  ...
                  >
                    ...
                    {isOpen && (
                      <div className="border-t border-slate-100 dark:border-slate-700 bg-slate-50/60 dark:bg-slate-800/20 px-5 py-4">
                        {!hasValues ? (
